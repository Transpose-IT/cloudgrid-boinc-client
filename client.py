...
# Modifications done for Cloudgrid by Jorn Argelo. All credits go to
...
class BoincClient(object):
    ...
    def get_project_status(self):
        ...
        #return Project.parse(self.rpc.call('<get_project_status/>'))
